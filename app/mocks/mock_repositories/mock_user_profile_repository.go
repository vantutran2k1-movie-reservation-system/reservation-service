...
//
//	mockgen -source=app/repositories/user_profile_repository.go -destination=app/mocks/mock_repositories/mock_user_profile_repository.go -package=mock_repositories
//
