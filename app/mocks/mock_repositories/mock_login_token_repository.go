...
//
//	mockgen -source=app/repositories/login_token_repository.go -destination=app/mocks/mock_repositories/mock_login_token_repository.go -package=mock_repositories
//
