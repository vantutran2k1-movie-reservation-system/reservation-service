...
//
//	mockgen -source=app/repositories/profile_picture_repository.go -destination=app/mocks/mock_repositories/mock_profile_picture_repository.go -package=mock_repositories
//
